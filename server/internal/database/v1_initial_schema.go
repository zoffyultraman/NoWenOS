...
func init() {
	Register(Migration{
		...
		enabled INTEGER NOT NULL DEFAULT 1
				...
				`CREATE TABLE IF NOT EXISTS installed_apps (id TEXT PRIMARY KEY, name TEXT, version TEXT, installed_at DATETIME)`,
		...
		created_at DATETIME DEFAULT CURRENT_TIMESTAMP
				...
				`CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT UNIQUE NOT NULL, password TEXT NOT NULL, role TEXT NOT NULL DEFAULT 'user', created_at DATETIME DEFAULT CURRENT_TIMESTAMP)`,
